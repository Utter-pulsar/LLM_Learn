        ...
        if os.path.isfile(file_path):
            ...
            for paragraph in paragraphs:
                ...
                for chunk in chunks:
                    if len(tokenizer.tokenize(chunk)) > chunk_size:
                        ...
                        for sub_chunk in sub_chunks:
                            if sub_chunk_accum and len(
                                    tokenizer.tokenize(sub_chunk_accum + sub_chunk + ' ')) > chunk_size:
                ...
                for chunk in final_chunks:
                    ...
                    all_chunks[chunk_id] = {"text": chunk,
                                            "metadata": {"file_name": sku}}  # Initialize metadata as dict
...
if __name__ == '__main__':
    ...
    save_json('./RAGDataset/ragJson/doc_store.json', docs)
    save_json('./RAGDataset/ragJson/vector_store.json', vec_store)
    ...
    print("-" * 50, "This is the line", "-" * 50)

    query_str = "帮我算一下1+1"
    vec_store = open_json('./RAGDataset/ragJson/vector_store.json')
    ...
    for match in matches:
        ...
        print(type(docs[match[0]][match[1]]))

    print(matches[0][2])
    print(docs[matches[0][0]][matches[0][1]])
